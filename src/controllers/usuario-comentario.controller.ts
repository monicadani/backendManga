...
export class UsuarioComentarioController {
  ...
  async find(
    ...
    return this.usuarioRepository.comentarios(id).find(filter);
  }
  ...
  async create(
    ...
    return this.usuarioRepository.comentarios(id).create(comentario);
  }
  ...
  async patch(
    ...
    return this.usuarioRepository.comentarios(id).patch(comentario, where);
  }
  ...
  async delete(
    ...
    return this.usuarioRepository.comentarios(id).delete(where);
  }
}
